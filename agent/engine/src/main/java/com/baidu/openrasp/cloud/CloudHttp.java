...
public class CloudHttp implements Request {
    ...
    public static void skipSSL(HttpsURLConnection conn) throws NoSuchProviderException, NoSuchAlgorithmException, KeyManagementException, MalformedURLException {
